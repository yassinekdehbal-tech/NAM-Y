// ─── DONNÉES (chargées depuis Supabase via supabase-client.js) ─
let CHAUFFEURS = [];
let ENTREPRISES = [];
...
const FALLBACK_EXPEDITIONS = [
  {
    id: 12125, tournee: null, exp_nom: 'TRUFFAUT PLAISIR', exp_adresse: 'Avenue de Sainte-Apolline', exp_cp: '78370', exp_ville: 'Plaisir',
    ...
    date_livraison: '2026-04-20', creneau: '15:00-18:00', poids: 250, poids_lourd: 40, taille: 180, nb_colis: 34, lieu: 'Pièce du choix',
    description: 'plantes et 4 sacs tereaux', prix_ht: 103.20/1.2, prix_ttc: 103.20, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12124, tournee: null, exp_nom: 'TRUFFAUT CHATENAY', exp_adresse: 'Route de Paris', exp_cp: '92290', exp_ville: 'Châtenay-Malabry',
    ...
    date_livraison: '2026-04-11', creneau: '10:00-13:00', poids: 70, poids_lourd: 40, taille: 220, nb_colis: 5, lieu: 'Pièce du choix',
    description: 'mobilier jardin', prix_ht: 60/1.2, prix_ttc: 60, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12158, tournee: null, exp_nom: 'TRUFFAUT LE CHESNAY', exp_adresse: 'Centre commercial Parly 2', exp_cp: '78150', exp_ville: 'Le Chesnay',
    ...
    date_livraison: '2026-04-11', creneau: '09:00-13:00', poids: 200, poids_lourd: 90, taille: 310, nb_colis: 12, lieu: 'Pièce du choix',
    description: 'canapé + table basse', prix_ht: 169.20/1.2, prix_ttc: 169.20, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12094, tournee: null, exp_nom: 'TRUFFAUT PLAISIR', exp_adresse: 'Avenue de Sainte-Apolline', exp_cp: '78370', exp_ville: 'Plaisir',
    ...
    date_livraison: '2026-04-07', creneau: '09:00-13:00', poids: 30, poids_lourd: 10, taille: 120, nb_colis: 3, lieu: 'Pièce du choix',
    description: 'bacs à fleurs', prix_ht: 60/1.2, prix_ttc: 60, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12035, tournee: null, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-04-04', creneau: '13:00-17:00', poids: 139, poids_lourd: 70, taille: 220, nb_colis: 8, lieu: 'Pièce du choix',
    description: 'étagères bois', prix_ht: 60/1.2, prix_ttc: 60, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12074, tournee: null, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-04-04', creneau: '13:00-16:00', poids: 64, poids_lourd: 8, taille: 180, nb_colis: 4, lieu: 'Pièce du choix',
    description: 'jardinières', prix_ht: 60/1.2, prix_ttc: 60, statut: 'planifie', type_prix: 'Poids'
  },
  {
    id: 12080, tournee: 104, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-04-04', creneau: '13:00-17:00', poids: 70, poids_lourd: 20, taille: 139, nb_colis: 5, lieu: 'Pièce du choix',
    description: 'mobilier salon', prix_ht: 30/1.2, prix_ttc: 30, statut: 'planifie', type_prix: 'Poids'
  },
  {
    id: 12156, tournee: null, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-04-04', creneau: '09:00-13:00', poids: 105, poids_lourd: 18, taille: 100, nb_colis: 6, lieu: 'Pièce du choix',
    description: 'table + chaises', prix_ht: 30/1.2, prix_ttc: 30, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12141, tournee: null, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-04-03', creneau: '13:00-16:00', poids: 30, poids_lourd: 7, taille: 100, nb_colis: 2, lieu: 'Pièce du choix',
    description: 'chaises pliantes', prix_ht: 30/1.2, prix_ttc: 30, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 12143, tournee: null, exp_nom: 'TRUFFAUT CHATENAY', exp_adresse: 'Route de Paris', exp_cp: '92290', exp_ville: 'Châtenay-Malabry',
    ...
    date_livraison: '2026-04-03', creneau: '10:00-13:00', poids: 128, poids_lourd: 128, taille: 120, nb_colis: 8, lieu: 'Pièce du choix',
    description: 'dalle terrasse', prix_ht: 126/1.2, prix_ttc: 126, statut: 'en_attente', type_prix: 'Poids'
  },
  {
    id: 11784, tournee: 123, exp_nom: 'TRUFFAUT GRIGNY', exp_adresse: 'N7', exp_cp: '91350', exp_ville: 'Grigny',
    ...
    date_livraison: '2026-03-18', creneau: '09:00-14:00', poids: 60, poids_lourd: 30, taille: 220, nb_colis: 2, lieu: 'Pièce du choix',
  ...
  {
    id: 12119, tournee: 104, exp_nom: 'TRUFFAUT PARIS RIVE GAUCHE', exp_adresse: '85 Quai de la Gare', exp_cp: '75013', exp_ville: 'Paris',
    ...
    date_livraison: '2026-03-29', creneau: '09:00-13:00', poids: 80, poids_lourd: 30, taille: 200, nb_colis: 5, lieu: 'Pièce du choix',
...
async function loadFromSupabase() {
  try {
    const [
      ...
      Promise.resolve({ value: { data: [] } }),  // stats_chauffeurs → calculé depuis tournee_stops
    ]);
